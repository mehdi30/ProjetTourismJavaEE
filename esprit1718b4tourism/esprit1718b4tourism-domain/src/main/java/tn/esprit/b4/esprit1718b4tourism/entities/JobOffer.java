...
public class JobOffer implements Serializable {
	...
	private int applyNbr; 
	
	@OneToMany(mappedBy="testJobOffer",fetch=FetchType.EAGER)
	...
	public JobOffer(int idOffer, String title, String city, Date postDate, String sector, String studyLevel,
			...
			String finishingHour, String hoursPerMonth) {
		super();
	...
	public int getApplyNbr() {
		return applyNbr;
	}

	public void setApplyNbr(int applyNbr) {
		this.applyNbr = applyNbr;
	}
