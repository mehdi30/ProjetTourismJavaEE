...
import tn.esprit.b4.esprit1718b4tourism.services.JobOfferEJBRemote;
...
public class JobOfferController extends AnchorPane implements Initializable{
    ...
    */
    ...
    void search(KeyEvent event) throws NamingException {
			...
			proxy = (JobOfferEJBRemote) ctx.lookup("esprit1718b4tourism-ear/esprit1718b4tourism-service/JobOfferEJB!tn.esprit.b4.esprit1718b4tourism.services.JobOfferEJBRemote");
    ...
    void validation(ActionEvent event) {
		navigate("JobOfferValidation.fxml");
    ...
    private void navigate(String fxml) {
        try {
            ...
            Stage currentStage = (Stage) valid.getScene().getWindow();
    ...
    void approuveOffer(ActionEvent event) throws NamingException {
		...
		if( JobOfferTable.getSelectionModel().isSelected(i)){
			...
			String mail="chemingui.azer@gmail.com";
		       String pass="a7z8e9q4s5d6w1x2c3";
	       String[] to={"azerrr19@gmail.com"};
    ...
    void rejectOffer(ActionEvent event) throws NamingException {
		...
		if( JobOfferTable.getSelectionModel().isSelected(i)){
			...
			proxy = (JobOfferEJBRemote) ctx.lookup("esprit1718b4tourism-ear/esprit1718b4tourism-service/JobOfferEJB!tn.esprit.b4.esprit1718b4tourism.services.JobOfferEJBRemote");
			JobOffer o = JobOfferTable.getItems().get(i);
			o.setApprouved(false);
			proxy.updateJobOffer(o);
			data = FXCollections.observableArrayList(proxy.FindByState(true));
			JobOfferTable.setItems(data);
	       ...
	       String subject="From Tourism Administration";
	       String body="we're sending  you this mail to inform you that the job offer that you have posted '"+o.getTitle()
			    ...
			    if(items.getSelectionModel().getSelectedItem().equals("All")){
					...
					try {
						...
						JobOfferEJBRemote proxy = (JobOfferEJBRemote) ctx
								.lookup("esprit1718b4tourism-ear/esprit1718b4tourism-service/JobOfferEJB!tn.esprit.b4.esprit1718b4tourism.services.JobOfferEJBRemote");
