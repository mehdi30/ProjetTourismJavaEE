...
public class SouvenirController extends AnchorPane implements Initializable {
	...
	public static float pricee;
	   ...
	   // private TableColumn<Souvenir, String> ColumnTime;
	    ...
	    @FXML
	    private JFXButton articleb;
	    @FXML
	    private JFXButton experienceb;  
	    
	    @FXML
	    private JFXButton baaaaaack;
	    ...
	    void Search(KeyEvent event) throws NamingException {
			...
			ObservableList<Souvenir> data = FXCollections.observableList(proxy.advancedSearchSouvenir(searchForum.getText()));
...
void experienceb(ActionEvent event) {
	Switch("Souvenir.fxml");

}
@FXML
void articleb(ActionEvent event) {
	Switch("Souvenir.fxml");
